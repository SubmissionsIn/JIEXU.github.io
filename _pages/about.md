...
1. Lujing Wang, Weifeng Yuan, Lu Zeng, **Jie Xu**, Yujie Mo, Xinxiang Zhao, Liang Peng. Dementia Analysis from Functional Connectivity Network with Graph Neural Networks. Information Processing and Management ({IP\&M, IF=8.6}), 2022.
